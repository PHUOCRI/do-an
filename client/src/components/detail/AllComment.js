        ...
        <>
          <Col span={18} style={{ marginTop: "1rem" }} xs={24} sm={24} md={18}>
              ...
              <div style={{ display: "flex" }}>
                {comment.isAdmin ? (
                  <div className="all-comment-info-name admin">
                    <img src="https://cellphones.com.vn/skin/frontend/default/cpsdesktop/images/media/logo.png" alt="logo admin" />
                  </div>
                ) : (
            ...
            <div className="all-comment-more">
              <button type="button" className="all-comment-more-chat" onClick={() => showRepComment(comment._id)}>
