    ...
    return (
        <div className="">
                    ...
                    <Row>
                        ...
                        <Col span={10}>
                            {starRatings.map(rating => (
                                <li key={`star-${rating.stars}`} className="thongke">
                                    <div className="numstar">
                                        {rating.stars} <StarOutlined style={{color: 'orange', margin: '0 5px'}}></StarOutlined>
                                    </div>
            ...
            <Row style={{marginTop: '1rem'}}>
                ...
                <Col key={item._id} span={18} align='start' xs={24} sm={24} md={18}>
